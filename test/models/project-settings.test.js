...
describe('ProjectSettings', () => {
  before(function () {
    this.cwd = pmock.cwd(path.resolve(__dirname, '../../src'));
  });
  ...
  describe('#settingsPath', () => {
    it('returns current directory with .metalpress appended', () => {
  ...
  describe('#buildFromTemplate', () => {
    it('doesnt have .metalpress already present', () => {
      const fn = () => {
    ...
    it('copies .metalpress in templates and makes copy in directory root', () => {
  ...
  describe('#loadSettings', () => {
    it('loads settings from .metalpress if already exists', () => {
      fs.writeFileSync(
    ...
    it('creates a new .metalpress if not present', () => {
      new ProjectSettings();
